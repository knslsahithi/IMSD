...
// Define a sample URL 
const myUrl = new 
URL('https://www.example.com:8080/path/page.html?name=JohnDoe&age=25#section2'); 
...
console.log('Search      
console.log('Hash        
 :', myUrl.search);     // ?name=JohnDoe&age=25 
 :', myUrl.hash);      
// Access query parameters 
console.log('Query Parameters:'); 
console.log('N ame        
 // #section2 
 :', myUrl.searchParams.get('name')); // JohnDoe 
console.log('Age          
:', myUrl.searchParams.get('age'));  // 25 
