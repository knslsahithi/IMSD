...
// 2. Create a web server using createServer() method 
const server = http.createServer((req, res) => { 
// 3. Display that a request has been received 
console.log("Request received from browser..."); 
// 4. Set the response header (status code & content type) 
res.writeHead(200, { 'Content-Type': 'text/html' }); 
// 5. Write the response content (HTML code) 
